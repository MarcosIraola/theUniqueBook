...
import foto from './assets/STAR.png';
...
const Main = () => {
    ...
    return (
        <div className={styles.contenedor}>
            ...
            <h1 className={styles.titulo}>-STAR-</h1>
            
            <div className={styles.main}>
                <div className={styles.parrafoMain}>
                    <img className={styles.t} src={t}/>
                    <p className={styles.parrafo}>
                        oday, a part of me is leaving, I am about to die and I am very happy. I know this might sound a little bit odd. But while there are those who are afraid of death and think of it as an end, to me, from up here in the sky, death is a fascinating experience. It is re-birth. An opportunity to come to life once again. A continuous process of transformation and liberation. A reminder of eternity.<br/>
                        For the ones who read these words with dislike and fear: you will understand this when you identify yourself as soul or maybe after, when you finally die consciously.<br/>
                        But this is not the point. The point is that I am happy because I came here to write down on this Book my favorite story. This is a story you may think you have heard before. A story that has been told in many different languages through all the existing human cultures on Earth.  But the truth is that you only know half of it and trust me, this is an opportunity to know it all.<br/>
                    </p>
                </div>

                <p className={styles.parrafo}>
                    Many years ago – I don’t remember exactly how many- I guided three men. They had a clear purpose and I had mine as well: to become their guide. These men had different ways to connect with me and receive my messages. The first one was a rich and recognized astronomer. He followed my movements through his cartographic skills. He was a great observer of the sky. The second one reached out from the bottom of his soul. Wondering in his inner world, he found the way to see my signals in the outer one.  And the third one, the most innocent one, was a man of intuition. Deep inside, he knew his journey had a purpose. He travelled without knowing where he would end up, letting himself be carried away by his heart, convinced that there was something invisible, a kind of magnet that took him to the places where he had to be.
                </p>

                <div className={styles.parrafoConFoto}>
                    <p className={styles.parrafoConFoto}>
                        Their names: Gaspar, Melchior and Balthazar. It is important for you to know they were not kings. Only Gaspar was rich, still he was not a king. He lived in a White Palace with his wife, who had the most beautiful hair of the village. He was a man of science but above all, he was a spiritual being. He loved to spend time in the water in silence, asking himself the real questions of life. And those are the moments when stars, like me, love to come down and visit Earth.
                        <br/>
                        I remember so dearly that morning. He woke up early, he left his clothes on top of a circular bench and entered the bathroom. His beard was as long as his hair and they became one when his body got under the water. He looked at the bench where he had left his clothes. Everything was so still.  The walls gradually began to lighten as the dawn light entered through window of the ceiling. He wasn’t fully awake. He closed his eyes and immediately visualized a mountain in front of him. A triangle. A geometric mountain with two possible paths. I showed him the faces of two other men that were also observing the mountain as he did. Suddenly, he saw a point in the middle of the triangle. And inside the point, he could read a date and a location. It was a meeting point. While he repeated the information out loud, the door opened, and his wife came in.
                    </p>
                    <img className={styles.imgStar} src={foto}/>
                </div>
                ...
                <p className={styles.separador}>
                    ...
                    <br/>
                    When the day of his departure arrived, he kissed his wife, and she hugged him back with enthusiasm. For the first time, Gaspar looked hesitant. He was afraid to leave her alone and not ever return back home. But she was calm and loving. She looked him in the eye and dropped a few words in his ear. He smiled, reached out to his pocket, and found a piece of paper. She didn’t let him read it. Not yet, she said. And with a smile on his face, Gaspar got on his camel and greeted all those who had come to wish him luck.
                    <br/>
                    Two weeks later, almost halfway there, he stopped by at a small house in the middle of nowhere. He was well received by an old man, who lived by himself. When Gaspar walked into the house, his eyes widened in surprise. On the walls he found drawings like the ones he made.
                    <br/>
                ...
                <p className={styles.parrafo}>
                    There was no need to answer that question. They connected with each other right away. They spent the whole night talking, pooling everything they knew. And they laughed and got excited when they went outside to watch the moon. It got late and the man offered Gaspar to spend the night there, and he accepted.
                    <br/>
                    ...
                    <br/>
                    The man, full of curiosity, asked if he could take a look at his map. Gaspar -proud and confident- spread the document over the table, waiting for the approval of an old astronomer. However, he began to laugh.
                </p>
